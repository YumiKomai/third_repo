...
```{r echo=false}
 library(xlsx)
Data_Education_and_Internet_Access <- read.xlsx("/Users/komaiyumi/Desktop/Social Sicence/third_repo/Data Education and Internet Access.xlsx",1)
```
...
##Give new variable
names(Data_GDPperCAPITA_and_Internet_Acess) <- c('Country', 'GDP per capita(constant 2000 US$)', 'Internet Uers(per 100 people)')
