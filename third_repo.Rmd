...
To prove this hypothesis we plot these variables of all countries, which have different internet accessibility rate, student's academic ability and economic growth. Then, we have analyzed the correlation between these variables.
...
These plots show the strong correlation between internet accesibility and average schoolong year and quality of education system.
...
- internet accesibility and average schoolong year: 0.72
- internet accesibility and quality of education system: 0.80
...
The result shows the strong correlation between internet accesibility and GDP per capita.
